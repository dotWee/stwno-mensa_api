...
Checkout the [API documentation](https://rgb-mensa-api.herokuapp.com/api-docs) generated by [Swagger](http://swagger.io) for informations on how to use the RESTful API (see the configuration file _[swagger.json](src/swagger.json)_, also hosted on [Swagger-Hub](https://app.swaggerhub.com/apis/dotWee/rgb-mensa_api)).
